...
//
//    @MockBean
//    private WorkflowRepository mockRepository;
//
//    @Before
//    public void init() {
//        Workflow book = new Workflow(1L, "Book Name", "Mkyong", new BigDecimal("9.99"));
...
//
//        List<Workflow> books = Arrays.asList(
//                new Workflow(1L, "Book A", "Ah Pig", new BigDecimal("1.99")),
//                new Workflow(2L, "Book B", "Ah Dog", new BigDecimal("2.99")));
//
...
//
//        Workflow newBook = new Workflow(1L, "Spring Boot Guide", "mkyong", new BigDecimal("2.99"));
//        when(mockRepository.save(any(Workflow.class))).thenReturn(newBook);
//
...
//        JSONAssert.assertEquals(expected, response.getBody(), false);
//
//        verify(mockRepository, times(1)).save(any(Workflow.class));
//
//    }
//
//    @Test
...
//
//        Workflow updateBook = new Workflow(1L, "ABC", "mkyong", new BigDecimal("19.99"));
//        when(mockRepository.save(any(Workflow.class))).thenReturn(updateBook);
//
...
//
//        when(mockRepository.save(any(Workflow.class))).thenReturn(new Workflow());
...
//
//        verify(mockRepository, times(1)).findById(1L);
//        verify(mockRepository, times(0)).save(any(Workflow.class));
//    }
//
//    @Test
