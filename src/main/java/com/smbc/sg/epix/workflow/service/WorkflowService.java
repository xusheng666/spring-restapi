...
public interface WorkflowService {
	 ...
	 * 
	 * Any Workflow record fulfill the search criteria (filter parameter)  
	 * Return empty list if no record fulfill the criteria.
	 * 
	 * 
	 ...
	 * @throws ServiceException Throw the exception when same Workflow code already 
	 * existed in database.
	 */
	 ...
	 * @param userId Current user id
	 * @return Return true if updated successful, otherwise return false.
	 * @throws ServiceException Throw the exeption when
	 * 1. The Workflow cannot be found in database
	 * 2. The provided field names are invalid.
	 */
	public Boolean modifyWorkflow(String userId, Long uid, Map<String, String> workflow) throws ServiceException;
